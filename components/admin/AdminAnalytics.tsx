...
import { Lease, LeaseStatus, Role } from '../../types';
...
export const AdminAnalytics: React.FC<AdminAnalyticsProps> = ({ leases, onBack }) => {
    ...
    const metrics = useMemo(() => {
        ...
        const avgAiLatency = countAiLeases > 0 ? totalAiLatency / countAiLeases : 0;
        const successRate = totalFiles > 0 ? Math.round((abstractedCount / totalFiles) * 100) : 0;
