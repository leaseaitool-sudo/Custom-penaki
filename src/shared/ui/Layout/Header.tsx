...
import { Bars3Icon } from '@/shared/ui/Icons/Bars3Icon';
...
export const Header: React.FC<HeaderProps> = ({ activeView, user, onProfileClick, onLogout, onMenuClick, onNavigate, onBookDemo, isSidebarOpen }) => {
